...
def get_server_command(
    ...
    # check if the model path is mounted if not vllm/sglang/trtllm-like servers;
    # these server types can also pass model name as "model_path" so we need special processing.
    if server_type not in ["vllm", "vllm_multimodal", "sglang", "trtllm", "nemo_asr", "generic"]:
